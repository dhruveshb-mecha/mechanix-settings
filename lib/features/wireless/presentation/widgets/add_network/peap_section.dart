...
class _PeapSectionState extends State<PeapSection> {
        ...
        EnterpriseRow(
          ...
          child: Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<PeapVersion>(
                value: config.peapVersion,
                isExpanded: true,
                items: PeapVersion.values
                    .map(
                      (e) => DropdownMenuItem(
                        value: e,
                ...
                onChanged: (value) {
                  ...
                  onChanged(config.copyWith(peapVersion: value));
                },
              ),
            ),
          ),
